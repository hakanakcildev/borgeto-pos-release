...
function CustomerTablesManagementContent() {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        customerTablesData = customerTablesData.map((table) => {
          ...
          const lastOrderDate = tableOrders.length > 0
            ? new Date(Math.max(...tableOrders.map(o => o.updatedAt.getTime())))
  ...
  return (
    <div className="h-full w-full flex flex-col overflow-hidden">
      <div className="flex-shrink-0 p-4 xl:p-6 border-b border-gray-200 dark:border-gray-700">
                ...
                >
                  <div className="flex items-start justify-between mb-3 flex-shrink-0">
                    ...
                    <Button
                      ...
                      className="text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-900/20 flex-shrink-0 ml-2"
                    >
